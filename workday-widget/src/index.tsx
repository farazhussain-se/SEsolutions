...
import { WorkdayWidgetProps, WorkdayWidget } from "./workday-widget";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/workday-widget.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <workday-widget></workday-widget>
   */
  return class WorkdayWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): WorkdayWidgetProps {
      const attrs = this.parseAttributes<WorkdayWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<WorkdayWidget {...this.props} />);
    }
