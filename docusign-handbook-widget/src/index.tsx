...
import { DocusignHandbookWidgetProps, DocusignHandbookWidget } from "./docusign-handbook-widget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <docusign-handbook-widget></docusign-handbook-widget>
   */
  return class DocusignHandbookWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): DocusignHandbookWidgetProps {
      const attrs = this.parseAttributes<DocusignHandbookWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<DocusignHandbookWidget {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "docusign-handbook-widget",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'DocuSign Handbook Widget',
    iconUrl: icon
};
