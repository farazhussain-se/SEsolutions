...
import { CarmaxStockWidgetProps, CarmaxStockWidget } from "./carmax-stock-widget";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/carmax-stock-widget.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <carmax-stock-widget ticker="KMX"></carmax-stock-widget>
   */
  return class CarmaxStockWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): CarmaxStockWidgetProps {
      const attrs = this.parseAttributes<CarmaxStockWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<CarmaxStockWidget {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "carmax-stock-widget",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'CarMax Stock Widget',
    iconUrl: icon
};
