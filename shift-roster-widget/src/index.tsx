...
import { ShiftRosterWidgetProps, ShiftRosterWidget } from "./shift-roster-widget";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/shift-roster-widget.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <shift-roster-widget></shift-roster-widget>
   */
  return class ShiftRosterWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): ShiftRosterWidgetProps {
      const attrs = this.parseAttributes<ShiftRosterWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<ShiftRosterWidget {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "shift-roster-widget",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'Shift Roster Widget',
    iconUrl: icon
};
