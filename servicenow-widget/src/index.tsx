...
import { ServiceNowWidgetProps, ServiceNowWidget } from "./servicenow-widget";
import { configurationSchema, uiSchema } from "./configuration-schema";
import icon from "../resources/servicenow-widget.svg";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <servicenow-widget></servicenow-widget>
   */
  return class ServicenowWidgetBlock extends BaseBlockClass implements BaseBlock {
    ...
    private get props(): ServiceNowWidgetProps {
      const attrs = this.parseAttributes<ServiceNowWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ...
      this._root.render(<ServiceNowWidget {...this.props} />);
    }
...
const blockDefinition: BlockDefinition = {
    name: "servicenow-widget",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'ServiceNow Widget',
    iconUrl: icon
};
